...
module.exports = {
  ...
  db: process.env.MONGODB || 'mongodb://localhost:27017/bookmarkies',

  sessionSecret: process.env.SESSION_SECRET || 'The uplift mofo bookmarkies party plan',
  ...
  foursquare: {
    clientId: process.env.FOURSQUARE_ID || '2STROLSFBMZLAHG3IBA141EM2HGRF0IRdIBB4KXMOGA2EH3JG',
